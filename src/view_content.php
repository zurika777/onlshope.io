    ...
    <div class="block__content">   <!--block__content-->
        ...
        if (mysqli_num_rows($result1) > 0)
        {
            ...
            do
            {
                ...
                if ($row1['stock'] == 1){
                    $stock = '<p class="stock_text"><img src=images/bx-check.svg> მარაგშია</p>';
                }else {
                    $stock = '<p class="stock_text"><img src=images/no-check.svg> არ არის მარაგში</p>';
                }
                echo '
                <div id="block-breadcrumbs-and-rating">
                <p id="nav-breadcrumbs"><a href="view.cat.php?type='.$row1["type_tovara"].'">'.$row1["type_tovara"].'</a> \ <span>'.$row1["brand"].'</span></p>
               ...
               <li><img src="images/eye.svg"  width="20" alt="eye"><p>'.$row1["count"].'</p></li>
               <li><img src="images/comment.svg"  width="18" alt="comment"><p>'.$count_reviews.'</p></li>
                </ul>
