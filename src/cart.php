...
if (isset($_POST["submitdata"]))
{
    ...
    {
        mysqli_query($link, "INSERT INTO `orders` (`order_datetime`, `order_dostavka`, `order_pay`, `order_type_pay`, `order_fio`, `order_address`, `order_phone`, `order_note`, `order_email`)
VALUES(NOW(),
            ...
            case 'confirm':
              ...
              ';
                ...
                if ($_SESSION['auth'] != true )
                {
                    ...
                    echo '
                  <li><label for="order_fio">ფიო<span class="star1">*</span></label><input type="text" name="order_fio" id="order_fio" value="'.$orderFio.'" /><span class="order_span_style">მაგ : ივანე ჯავახიშვილი</span></li>
                  <li><label for="order_email">E-mail<span class="star1">*</span></label><input type="text" name="order_email" id="order_email" value="'.$orderEmail.'"  /><span class="order_span_style">მაგ : admin@gmail.com</span></li>
                  <li><label for="order_phone">ტელეფონი<span class="star1">*</span></label><input type="text" name="order_phone" id="order_phone" value="'.$orderPhone.'"  /><span class="order_span_style">მაგ : 5 99 77-77-77</span></li>
                  <li><label class="order_label_style" for="order_address">მიწოდების აგილი<span class="star1">*</span></label><input type="text" name="order_address" id="order_address" value="'.$orderAddress.'"  />
                ...
                echo '<li><label class="order_label_style" for="order_note">დამატებით</label><textarea name="order_note">'.$orderNote.'</textarea><span>დაზუსტება მიწოდების ადგილის.<br /> შესაბამის დროს დარეკვა<br /> ჩვენი მენეჯერის მიერ</span></li></ul>
              ...
              ';
                ...
                if ($_SESSION['auth'] == true) { // если пользователь авторизован
                    echo '<ul id="list-info">
                                <li><strong>ნივთის კოდი : </strong>'.$_SESSION['order_id'].'</li>
                                ...
                                <li><strong>დამატებითი ინფორმაცია : </strong>'.$orderNote.'</li>
                        </ul>';
