...
// gadasvla linkebze navigaciis
switch ($go) {
    case "news":
        $query_aystopper = " WHERE visible = '1' AND new = '1'";
        $name_aystopper = "ახალი დამატებულები";
        break;
    case "leaders":
        $query_aystopper = " WHERE visible = '1' AND leader = '1'";
        $name_aystopper = "ყველაზე გაყიდვადი";
        break;
    case "sale":
        $query_aystopper = " WHERE visible = '1' AND sale = '1'";
        $name_aystopper = "ლიკვიდაცია";
        break;
    case "stock":
        $query_aystopper = " WHERE visible = '1' AND stock = '1'";
        $name_aystopper = "მარაგშია";
        break;
    default:
        $query_aystopper = "";
        break;
    ...
    <div class="block__content">   <!--block__content-->
        ...
        if ($query_aystopper != "")
        {
            ...
            <div class="block-sorting"><!--block__sorting-->
                <p class="nav-breadcrumbs"><a class="nav-breadcrumbs-link" href="index.php">მთავარი</a> \ <span class="nav-breadcrumbs-link"><?php echo $name_aystopper; ?></span></p>
                <div class="options-list">
                    ...
                    <div><a id="select-sort" href="#"><?php echo $sort_name; ?></a></div>
                    <div id="sorting-list">

                        <div><a class="select-sort" href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-asc">იაფიანიდან ძვირამდე</a></div>
                        <div><a class="select-sort" href="view_aystopper.php?go=<?php echo $go; ?>&sort=price-desc">ძვირიანიდან იაფამდე</a></div>
                        <div><a class="select-sort" href="view_aystopper.php?go=<?php echo $go; ?>&sort=popular">პოპულარული</a></div>
                        <div><a class="select-sort" href="view_aystopper.php?go=<?php echo $go; ?>&sort=news">ახლები</a></div>
                        <div><a class="select-sort" href="view_aystopper.php?go=<?php echo $go; ?>&sort=brand">ა დან ბ მდე</a></div>
...
<div class="style-text-list">' . $row["mini_description"] . '</div>
            ...
            echo '</ul>';
                ...
                echo '<p>მზგავსი ნივთი არ არსებობს!</p>';
            }

            }else{
                echo "<p>ესეთი კატეგორია ვერ მოიძებნა!</p>";
            }
