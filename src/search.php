...
<head>
    ...
    <title>ძიება - <?php echo $search;?></title>
</head>
<body>
<div id="block__body"> <!--igive konteineria container-->
    ...
    <div class="block__content">   <!--block__content-->
        ...
        <?php
        if (strlen($search) >= 2 && strlen($search) < 60)
        {

            $num = 4;  // aq vutitebt ramdeni gvinda rom ganovitanot
            $page =  (int)$_GET['page'];
        ...
        if ($temp[0] > 0)   //es aris ziebis dros tu aris rame
            {

                echo '
                <div class="block-sorting"><!--block__sorting-->
            <p class="nav-breadcrumbs"><a class="nav-breadcrumbs-link" href="index.php">მთავარი</a> \ <span class="nav-breadcrumbs-link">ძიების რეზულტატი</span></p>
            <div class="options-list">
                ...
                <div id="sorting-list">
                    ...
                    <div><a class="select-sort" href="search.php?q='.$search.'&sort=price-asc">იაფიანიდან ძვირამდე</a></div>
                    <div><a class="select-sort" href="search.php?q='.$search.'&sort=price-desc">ძვირიანიდან იაფამდე</a></div>
                    <div><a class="select-sort" href="search.php?q='.$search.'&sort=popular">პოპულარული</a></div>
                    <div><a class="select-sort" href="search.php?q='.$search.'&sort=news">ახლები</a></div>
                    <div><a class="select-sort" href="search.php?q='.$search.'&sort=brand">ა დან ბ მდე</a></div>
...
<div class="style-text-list">' . $row["mini_description"] . '</div>
     ...
     ';
            ...
            }else{   //es aris ziebis dros tu aris rame   aq iketeba
            echo "<p>ვერაფერი ვერ მოიძებნა</p>";
            }
}else {
            echo "<p>საძიებო სიტყვა უნდა შეადგენდეს 3 -დან 150 სიმბოლომდე!</p>";
            }
            ?>
    </div> <!--/.block__content-->
    <div> <!--//footer-->
