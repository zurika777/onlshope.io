    ...
    <div id="block-body">
        ...
        <div id="block-content">
            ...
            if (mysqli_num_rows($result) > 0)
            {
                ...
                {
                echo '
                <p class="tovar-category">კატეგორია<a class="tovar-categorya" href="tovar.php?type='.$row["type_tovara"].'">'.$row["type_tovara"].'</a> \ <span>'.$row["brand"].'</span></p>
                ...
                ';
                            ...
                            $category = mysqli_query($link,"SELECT * FROM category ORDER BY type ASC");
                            if (mysqli_num_rows($category) > 0)
                            {
                                ...
                                if ($row["type_tovara"] == "scooter") $type_scooter ="selected";
                            ...
                            <option  '.$type_scooter.' value="scooter" >სკუტერები</option>
                        </select></li>
             ...
             <label class="stylelabel"><!--<p class="h3click-img-right"></p>-->ძირითადი სურათი</label>
               <div id="baseimg">    
                ...
                ';
                    ...
                    if ($row["stock"] == '1') $checked5="checked";
                ...
                <ul id="checkbox">
                    ...
                    <li><input type="checkbox" name="chk_stock" id="chk_stock" '.$checked5.'/><label for="chk_stock">IN STOCK</label></li>
                </ul>
