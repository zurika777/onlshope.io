...
if ($_SESSION['auth_admin'] == "yes_auth") {
    ...
    if ($_POST["submit_add"]) {
        ...
        if ($_POST["chk_sale"]) {
            ...
            mysqli_query($link, "INSERT INTO `table_products`(`products_id`, `title`, `price`, `brand`, `seo_words`, `seo_description`, `mini_description`, `images`, `description`, `mini_features`, `features`, `datetime`, `new`, `leader`, `sale`, `visible`, `stock`, `type_tovara`, `brand_id`, `yes_like`)
            ...
            <form  enctype="multipart/form-data" method="post">
                <ul id="edit-tovar">
                    ...
                    <li><label>ნივთის ტიპი</label><select name="form_type" id="type" size="1" >
                            ...
                            <option value="scooter" >სკუტერები</option>
                        </select></li>
                ...
                <ul id="checkbox">
                    ...
                    <li><input type="checkbox" name="chk_stock" id="chk_stock" /><label for="chk_stock">IN STOCK</label></li>
                </ul>
