...
if ($_SESSION['auth_admin'] == "yes_auth") {
            ...
            <ul id="options-list">
                ...
                <div id="list-links">
                 <ul>
                    ...
                    <ul>
                        <li><a href="tovar.php?cat=scooter"><strong>სკუტერები</strong></a></li>
                        <?php
                        $result1 = mysqli_query($link,"SELECT * FROM category WHERE type='scooter'");
                        if (mysqli_num_rows($result1) > 0)
                        {
                            $row1 =mysqli_fetch_array($result1);
                            do
  ...
  <p class="style__price-grid">'.group_numerals($row["price"]).' ₾</p>
</div>
<p class="link-action">
