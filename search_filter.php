        ...
        <div class="block-sorting"><!--block__sorting-->
            ...
            <div class="options-list">
                ...
                <div id="sorting-list">
                    ...
                    <div><a class="select-sort" href="search_filter.php?sort=price-asc">იაფიანიდან ძვირამდე</a></div>
                    <div><a class="select-sort" href="search_filter.php?sort=price-desc">ძვირიანიდან იაფამდე</a></div>
                    <div><a class="select-sort" href="search_filtert.php?sort=popular">პოპულარული</a></div>
                    <div><a class="select-sort" href="search_filter.php?sort=news">ახლები</a></div>
                    <div><a class="select-sort" href="search_filtert.php?sort=brand">ა დან ბ მდე</a></div>
...
<div class="style-text-list">'.$row["mini_description"].'</div>
            ...
            echo '</ul>';
            if ($page != 1){ $pstr_prev = '<li><a class="pstr-prev" href="search_filter.php?page='.($page - 1).'">&lt;</a></li>';}
            ...
            if ($total > 1)
            {
                ...
                echo $pstr_prev . $page5left . $page4left . $page3left . $page2left . $page1left . "<li><a class='pstr-active' href='filter_search.php?q=".$search."&page=".$page."'>".$page."</a></li>".$page1right.$page2right.$page3right.$page4right.$page5right.$strtotal.$pstr_next;
                echo '
                </ul>
                </div>
                ';
